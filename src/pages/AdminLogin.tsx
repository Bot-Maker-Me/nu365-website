      ...
      >
        <div className="glass rounded-2xl p-8 border border-[#1F1F2E]">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold font-heading tracking-tight">Admin Login</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="w-full h-11 gradient-bg text-white border-transparent relative overflow-hidden"
            >
